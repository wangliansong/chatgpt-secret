...
public class JwtLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    private static JSONObject loginObj;

    public JwtLoginFilter(AuthenticationManager authenticationManager, UserMapper userMapper, RedissonClient redissonClient) {
...
//        Object s = authResult.getPrincipal();
        ...
        String jwt = JwtUtils.createAccessToken(JSON.toJSONString(user));
        ...
        redissonClient.getBucket(JwtUtils.loginUserInfoRedisKey + userName).set(jwt);
    ...
    protected String obtainPassword(HttpServletRequest request) {
        //JSONObject result = getJsonObject(request);
        if(loginObj == null){
            loginObj = getJsonObject(request);
        }
        return loginObj.getString("password");
    ...
    protected String obtainUsername(HttpServletRequest request) {
        ...
        return loginObj.getString("username");
    ...
    private JSONObject getJsonObject(HttpServletRequest request) {
        ...
        try (BufferedReader reader = request.getReader();) {
            ...
            loginObj = JSON.parseObject(sb.toString());
        } catch (IOException e) {
            logger.error("", e);
        }
        return loginObj;
