...
import com.secret.chatgpt.front.config.JwtConfig;
import com.secret.chatgpt.front.enums.ResultCodeEnum;
import com.secret.chatgpt.front.exceptions.JwtApiException;
...
public class JwtUtils {
    public static void main(String[] args) {
        System.out.println(new Date(System.currentTimeMillis() + 36000 * 1000));
        System.out.println(new Date(System.currentTimeMillis() + 36000 * 1000));
